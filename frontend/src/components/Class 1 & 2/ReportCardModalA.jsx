...
const ReportCardModalA = ({ studentData, onClose }) => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      console.error(err);
      setDlStatus(null); // hide overlay on error (toast can handle it if needed)
    } finally {
                      ...
                      <table className="rc-table">
                        ...
                        <thead>
                          <tr className="rc-thead-row">
                            ...
                            <th className="rc-th">ORAL<br />EXAM<br />(10)</th>
                            <th className="rc-th">TERM 1<br />(30)</th>
                          ...
                          {SUBJECTS.map((s) => {
                            ...
                            return (
                              <tr key={s.key} className={`rc-tr${s.wrap ? ' rc-tr-tall' : ''}`}>
                                ...
                                <td className="rc-td rc-td-c">{safe(d.oralExam)}</td>
                      ...
                      <table className="rc-table">
                        ...
                        <thead>
                          <tr className="rc-thead-row">
                            ...
                            <th className="rc-th">NOTE<br />BOOK<br />(5)</th>
                            <th className="rc-th">ORAL<br />EXAM<br />(10)</th>
                            <th className="rc-th">TERM 2<br />(30)</th>
                            <th className="rc-th">OUT<br />OF<br />(50)</th>
                            <th className="rc-th">OUT<br />OF<br />(100)</th>
