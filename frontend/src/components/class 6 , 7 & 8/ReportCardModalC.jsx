...
const SUBJECTS = [
  ...
  { label: 'SOCIAL SCIENCE',   key: 'socialscience',  wrap: false },
...
/* ─────────────────────────────────────────────────────
   MAIN COMPONENT
───────────────────────────────────────────────────── */
const ReportCardModalC = ({ studentData, onClose }) => {
                      ...
                      <table className="rc-table">
                        ...
                        <thead>
                          <tr className="rc-thead-row">
                            ...
                            <th className="rc-th">PERIODIC<br />TEST<br />(10)</th>
                            <th className="rc-th">NOTE<br />BOOK<br />(5)</th>
                            <th className="rc-th">SUB<br />ENRICH<br/>MENT<br />(5)</th>
                            <th className="rc-th">TERM 1<br />(80)</th>
                          ...
                          {SUBJECTS.map((s) => {
                            ...
                            return (
                              <tr key={s.key} className={`rc-tr${s.wrap ? ' rc-tr-tall' : ''}`}>
                                ...
                                <td className="rc-td rc-td-c">{safe(d.subEnrichment)}</td>
                                <td className="rc-td rc-td-c">{safe(d.termExam)}</td>
                      ...
                      <table className="rc-table">
                        ...
                        <thead>
                          <tr className="rc-thead-row">
                            ...
                            <th className="rc-th">NOTE<br />BOOK<br />(5)</th>
                            <th className="rc-th">SUB<br />ENRICH<br/>MENT<br />(5)</th>
                            <th className="rc-th">TERM 2<br />(80)</th>
                            <th className="rc-th">OUT<br />OF<br />(100)</th>
